                ...
                <ul class="space-y-2">
                  ...
                  <li>
                    <button type="button" class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      aria-controls="dropdown-pillar1"
                      data-collapse-toggle="dropdown-pillar1">
                      <svg
                        aria-hidden="true"
                      ...
                      <span class="flex-1 ml-3 text-left whitespace-nowrap font-bold">PILLAR 1: Foundational Work</span>
                      <svg
                        aria-hidden="true"
                        class="w-6 h-6"
                        fill="currentColor"
                    ...
                    <ul id="dropdown-pillar1" class="hidden py-2 space-y-2">
                      <li>
                        ...
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                          Lesson 1: Awareness of customers</a>
                      </li>
                      <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                          Lesson 2: Signature framework design</a>
                      </li>
                      <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                          Lesson 3: Groundwork & essential tools</a>
                      </li>
                  ...
                  <li>
                    <button type="button" class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      aria-controls="dropdown-pillar2"
                      data-collapse-toggle="dropdown-pillar2">
                      <svg
                        aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor"
                      ...
                      <span class="flex-1 ml-3 text-left whitespace-nowrap">PILLAR 2: Power Content Strategy</span>
                      <svg
                        aria-hidden="true"
                        class="w-6 h-6"
                        fill="currentColor"
                    ...
                    <ul id="dropdown-pillar2" class="hidden py-2 space-y-2">
                      <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                          Settings</a>
                      </li>
                  ...
                  <li>
                    <button type="button" class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      aria-controls="dropdown-pillar3"
                      data-collapse-toggle="dropdown-pillar3">
                      <svg
                        aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        fill="currentColor"
                      ...
                      <span class="flex-1 ml-3 text-left whitespace-nowrap">PILLAR 3: Cheap Ad Strategy</span>
                      <svg
                        aria-hidden="true"
                        class="w-6 h-6"
                        fill="currentColor"
                    ...
                    <ul id="dropdown-pillar3" class="hidden py-2 space-y-2">
                      <li>
                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                          Settings</a>
                      </li>
